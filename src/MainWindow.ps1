...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid>
    ...
    <!-- Header -->
    <Border Grid.Row="0" Background="#1C1C2A">
      <Border.Effect>
      ...
      <Grid Margin="20,0">
        ...
        <Border Grid.Column="1" x:Name="TenantBadge" CornerRadius="4"
                Background="#1A2A4A" Padding="10,4" Visibility="Collapsed">
    ...
    <!-- Tenant bar -->
    <Border Grid.Row="1" Background="#1C1C2A" BorderBrush="#3C3C5A" BorderThickness="0,0,0,1">
    ...
    <!-- Status bar -->
    <Border Grid.Row="3" Background="#1C1C2A" BorderBrush="#3C3C5A" BorderThickness="0,1,0,0">
      <Grid Margin="14,0">
...
function Show-AddTenantDialog {
    $reader            = [System.Xml.XmlReader]::Create([System.IO.StringReader]::new($Script:AddTenantXaml))
