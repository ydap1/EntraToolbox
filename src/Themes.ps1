...
$Script:ThemePalettes = [ordered]@{
    'Default Dark' = @{
        ...
        SuccessBg='#0D2B1A'; DangerBg='#2B0D0D'; WarnText='#CC6666'
    }
    'Gruvbox' = @{
        ...
        SuccessBg='#2E3830'; DangerBg='#3C2E2E'; WarnText='#FB4934'
    }
    'Catppuccin Mocha' = @{
        ...
        SuccessBg='#1E2A23'; DangerBg='#2A1E1E'; WarnText='#F38BA8'
    }
    'Nord' = @{
        ...
        SuccessBg='#2E3B32'; DangerBg='#3B2E32'; WarnText='#BF616A'
    }
    'One Dark' = @{
        ...
        SuccessBg='#1E2A23'; DangerBg='#2A1E1E'; WarnText='#E06C75'
    }
}
...
function Invoke-ThemeXaml([string]$Xaml) {
    ...
    $Xaml -replace '#12121C',$t.Bg      -replace '#1C1C2A',$t.Surface `
          ...
          -replace '#0D2B1A',$t.SuccessBg -replace '#2B0D0D',$t.DangerBg `
          -replace '#CC6666',$t.WarnText
}
